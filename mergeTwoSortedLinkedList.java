...
public class mergeTwoSortedLinkedList {
    ...
    static SinglyLinkedListNode mergeLists(SinglyLinkedListNode head1, SinglyLinkedListNode head2) {
        ...
        LinkedList<Integer> hnode = new LinkedList<>();
        ...
        SinglyLinkedListNode h3 = new SinglyLinkedListNode(0);
        SinglyLinkedListNode curr = h3;
        while(!hnode.isEmpty()){

            curr.next = new SinglyLinkedListNode(hnode.poll());
            curr = curr.next;
