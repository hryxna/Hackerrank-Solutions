...
class Studentz extends Person{
    ...
    public Studentz(String firstName, String lastName, int identification, int[] scores) {
...
public class solInheritance {
    ...
    public static void main(String[] args) {
        ...
        Studentz s = new Studentz(firstName, lastName, id, testScores);
        s.printPerson();
